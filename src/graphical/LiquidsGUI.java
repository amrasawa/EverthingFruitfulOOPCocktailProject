...
import exceptions.CupOverFlowException;
...
public class LiquidsGUI extends javax.swing.JFrame {
    ...
    public LiquidsGUI(Blender blender) {
        ...
        //System.out.println(this.blender.getIngredientsString());
        liquidFlag = false;
        cupFlag = false;
    }

    public void setData(Blender blender) {
        this.blender = blender;
    }
...
// TODO add your handling code here:
    ...
    private void finishButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finishButtonActionPerformed
        ...
        try {
            ...
            //System.out.println("after adding sugar   " + blender.getIngredientsString());
            ...
            //System.out.println("after tippings   " + blender.getIngredientsString());
            //blending the cocktail before pouring it 
            try {
                blender.blend();
            } catch (BlenderIsEmptyException ex) {
                JOptionPane.showMessageDialog(this, ex.getMessage());
            }
            //getting the color of the cocktail
            ...
            System.out.println(blender.getColorString());
            // cups  
            Cup cup = null;
...
//Logger.getLogger(LiquidsGUI.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if (cup != null) {
                ...
                //the String we want to log 
                String toLog =  blender.getIngredientsString() + "\nCalories : " + Math.round(cup.getCocktailCalories()) + "\nPrice : " +Math.round(cup.getPrice())  + "\nColor :" + blender.getColorString();
                ...
                ResultOwnDrink result;
                result = new ResultOwnDrink(this.blender, cup, new Color(r, g, b));
                result.show();
